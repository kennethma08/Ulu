...
namespace Whatsapp_API.Data.Migrations
{
    ...
    [Migration("20260217062024_AddConversationHoldAndAssignFields")]
    partial class AddConversationHoldAndAssignFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Whatsapp_API.Models.Entities.Messaging.Attachment", b =>
                {
                    ...
                    b.Property<string>("WhatsappMediaId")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)")
                        .HasColumnName("whatsapp_media_id");
            ...
            modelBuilder.Entity("Whatsapp_API.Models.Entities.Messaging.Conversation", b =>
                {
                    ...
                    b.Property<int?>("OnHoldByUserId")
                        .HasColumnType("int")
                        .HasColumnName("on_hold_by_user_id");
                    ...
                    b.HasIndex(new[] { "CompanyId", "IsOnHold" }, "IX_conversations_company_id_is_on_hold");
